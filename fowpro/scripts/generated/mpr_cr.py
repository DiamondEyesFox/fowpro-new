...
class GenesisCreation(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # Spell effect
        effects = [
            EffectBuilder.put_into_field(from_zone="graveyard"),
        ]
        self.register_spell_effect(effects)
...
class GrimmiaTheSaviorOfMyth(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(ActivateAbility(
            ...
            effects=[EffectBuilder.grant_keyword(KeywordAbility.SWIFTNESS), EffectBuilder.grant_keyword(KeywordAbility.TARGET_ATTACK)],
        ))
...
class TheLittlePrince(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # [Continuous] ability
        # Scaling buff: this card gains +400/+400 per different total cost among resonators
        count_filter = TargetFilter(controllers=[TargetController.YOU], races=["different total cost among resonators"])
        ...
        self.register_ability(ContinuousAbility(
            name="This card gains [+400/+400] for each dif",
...
class BlackGoat(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(ActivateAbility(
            ...
            will_cost=WillCost(fire=1),
            effects=[EffectBuilder.deal_damage(200), EffectBuilder.remove_from_game()],
        ))
...
class CrimeAndPunishment(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # Spell effect
        effects = [
            EffectBuilder.deal_damage_variable(),
        ]
        self.register_spell_effect(effects)
...
class JubalTheGrandsireOfMusicians(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(AutomaticAbility(
            name="When this card attacks, if your J-Ruler ",
            trigger_condition=TriggerCondition.DECLARES_ATTACK,
            effects=[EffectBuilder.deal_damage(500)],
            is_mandatory=True,
        ))
...
class DarkShiningSwordsman(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(ActivateAbility(
            ...
            effects=[EffectBuilder.buff(0, 0, EffectDuration.INSTANT)],
        ))
...
class KaguyaTheImmortalPrincess(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # [Continuous] ability
        # Scaling buff: this card gains +200/+0 per treasury item
        ...
        def _apply_scaling_buff(target, game):
            ...
            target.current_def = (target.current_def or 0) + (0 * count)
        self.register_ability(ContinuousAbility(
            name="This card gains [+200/+0] for each Treas",
            continuous_effect=ContinuousEffect(
                name="This card gains [+200/+0] for each Treas",
                affects_self_only=True,
                apply_func=_apply_scaling_buff,
...
class ArtOfSinbad(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # Spell effect
        effects = [
            EffectBuilder.prevent_next_damage(),
        ]
        self.register_spell_effect(effects)
...
class AwakeningAtTheEnd(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # Spell effect
        effects = [
            EffectBuilder.buff(-700, -700, EffectDuration.UNTIL_END_OF_TURN),
        ]
        self.register_spell_effect(effects)
...
class BlackMiasma(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # Spell effect
        effects = [
            EffectBuilder.buff(300, 300, EffectDuration.UNTIL_END_OF_TURN),
        ]
        self.register_spell_effect(effects)
...
class ByakheeTheWingedLady(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(ActivateAbility(
            ...
            tap_cost=True,
            effects=[EffectBuilder.buff(900, 900, EffectDuration.UNTIL_END_OF_TURN), EffectBuilder.grant_keyword(KeywordAbility.FLYING)],
        ))
...
class NyarlathotepTheFacelessGod(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        # [Continuous] ability
        # TODO: dynamic ATK/DEF continuous effect not auto-generated yet
...
class ShiningTrapezohedron(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(ActivateAbility(
            ...
            will_cost=WillCost(darkness=1),
            effects=[EffectBuilder.put_into_graveyard()],
        ))
...
class ZeroTheMagusOfNull(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(AutomaticAbility(
            ...
            trigger_condition=TriggerCondition.ENTER_FIELD,
            effects=[EffectBuilder.buff(-200, -200, EffectDuration.UNTIL_END_OF_TURN), EffectBuilder.grant_keyword(KeywordAbility.FLYING), EffectBuilder.remove_keyword(KeywordAbility.FLYING)],
            is_mandatory=True,
        ))
...
class GhertaTheTearOfPassion(RulesCardScript):
    ...
    def initial_effect(self, game, card):
        ...
        self.register_ability(ActivateAbility(
            ...
            effects=[EffectBuilder.grant_keyword(KeywordAbility.SWIFTNESS), EffectBuilder.grant_keyword(KeywordAbility.FLYING)],
        ))
